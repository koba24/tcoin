...
#ifndef TCOIN_TEST_SCRIPTNUM10_H
#define TCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Tcoin Core 0.10.0, for cross-comparison.
 */
public:
