/* src/config/tcoin-config.h.  Generated from tcoin-config.h.in by configure.  */
/* src/config/tcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef TCOIN_CONFIG_H

#define TCOIN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Tcoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Tcoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/tcoin/tcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Tcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Tcoin Core 0.14.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "tcoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://tcoincore.org/"
