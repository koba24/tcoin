...
#ifndef TCOIN_QT_TCOINUNITS_H
#define TCOIN_QT_TCOINUNITS_H
...
/** Tcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class TcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit TcoinUnits(QObject *parent);

    /** Tcoin units.
      @note Source: https://en.tcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        TCN,
...
typedef TcoinUnits::Unit TcoinUnit;

#endif // TCOIN_QT_TCOINUNITS_H
