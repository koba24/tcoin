...
This document provides guidelines for internationalization of the Tcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `tcoin_en.ts` remains unchanged.
