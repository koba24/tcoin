Tcoin Core version 0.9.4 is now available from:

  https://tcoin.org/bin/0.9.4/
...
this update is incompatible with the Tcoin system and could lead to consensus
forks.

Tcoin Core released binaries from https://tcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~tcoin/+archive/ubuntu/tcoin
- A third-party or self-compiled Tcoin Core

upgrade to Tcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
