Tcoin Core version 0.10.4 is now available from:

  <https://tcoin.org/bin/tcoin-core-0.10.4/>
...
- #6953 `43c2789` Split tcoin-tx into its own package
- #6953 `dfe0d4d` Include tcoin-tx binary on Debian/Ubuntu
