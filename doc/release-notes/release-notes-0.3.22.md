Download URL: https://sourceforge.net/projects/tcoin/files/Tcoin/tcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 TCN fee schedule (users still pay 0.01 TCN per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #tcoin00 - #tcoin99
