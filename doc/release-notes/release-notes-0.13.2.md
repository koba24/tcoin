Tcoin Core version 0.13.2 is now available from:

  <https://tcoin.org/bin/tcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update tcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow tcoin-tx to create v2 transactions (btcdrak)
