Tcoin Core version 0.9.2.1 is now available from:

  https://tcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 TCN to 0.01 TCN
...
- Fix "Start tcoin on system login"
