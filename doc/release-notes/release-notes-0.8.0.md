Tcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/tcoin/files/Tcoin/tcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Tcoin
...
New/changed settings (command-line or tcoin.conf file)
--------------------------------------------------------
