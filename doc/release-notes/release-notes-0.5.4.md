Tcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/tcoin/files/Tcoin/tcoin-0.5.4/
...
http://gitorious.org/tcoin/tcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Tcoin-Qt notifications under Growl 1.3.
Increase required age of Tcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxTcoin properly when installing Tcoin-Qt over it. (Windows)
