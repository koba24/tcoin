...
unlocked to sign the Tcoin-Qt.app bundle.
...
allowing somebody to distribute a Tcoin-Qt.app or tcoin-qt-setup.exe with a valid
...
that the tcoin-qt.exe file inside the installer had not been tampered with.
