...
class RawTransactionsTest(TcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid tcoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid tcoin address" in e.error['message'])
