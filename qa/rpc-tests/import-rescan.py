...
import RPC call and node 0 sends TCN to it. Then other nodes import the
...
In the second part of the test, node 0 sends more TCN to each address, and the
...
class ImportRescanTest(TcoinTestFramework):
    def __init__(self):
        super().__init__()
